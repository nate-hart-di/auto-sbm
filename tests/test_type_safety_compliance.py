...
class TestTypeHintCoverage:
    ...
    def test_config_module_type_hints(self):
        ...
        from sbm.config import Config, get_config, get_settings
    ...
    def test_cli_module_critical_functions(self):
        ...
        from sbm.cli import is_env_healthy, auto
        ...
        assert hints['return'] == bool, "is_env_healthy should return bool"
        
        # Test auto command function
        hints = getattr(auto, '__annotations__', {})
        assert 'return' in hints, "auto command missing return type annotation"
...
class TestFutureAnnotationsUsage:
    ...
    def test_cli_has_future_annotations(self):
        ...
        assert "from __future__ import annotations" == first_import, \
...
class TestClickCommandTypeHints:
    ...
    def test_click_context_typing(self):
        ...
        # First parameter should be ctx with click.Context type
        params = list(sig.parameters.values())
        ctx_param = params[0]
        
        assert ctx_param.name == 'ctx', "First parameter should be 'ctx'"
        assert ctx_param.annotation == click.Context, \
            f"ctx parameter should be typed as click.Context, got {ctx_param.annotation}"
...
class TestImportStructure:
    ...
    def test_typing_imports_present(self):
        ...
        for module in modules_with_typing:
            ...
            ), f"Module {module.__name__} should import typing constructs"
